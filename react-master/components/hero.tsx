...
export default function Hero({ onFetchedDataUpdate }: { onFetchedDataUpdate: any }) {
  ...
  const handleButtonClick = (videoUrl: string) => {
    ...
    // Set the current video URL when starting to play
    if (!videoPlaying) {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">Predicting popularity and analysing language usage of TED talks</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Add a link to a YouTube video you want to analyse...</p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
            
            <form className="w-full lg:w-1/2" data-aos="fade-up" data-aos-delay="400">
          <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none">
            <input
              type="link"
              className="w-full appearance-none rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4"
          ...
          <ModalVideo
            ...
            onFetchedDataUpdate={onFetchedDataUpdate}
             />
        </div>
      </div>
    </section>
